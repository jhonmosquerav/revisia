...
**perezosa**: importar ``prisma_loop`` NO requiere tener instalado ningún SDK
...
if TYPE_CHECKING:
    from prisma_loop.llm.base import LLMProvider
...
_BUILDERS: dict[str, tuple[str, str]] = {
    "gemini": ("prisma_loop.llm.providers.gemini", "GeminiProvider"),
    "openai": ("prisma_loop.llm.providers.openai_api", "OpenAIProvider"),
    "anthropic": ("prisma_loop.llm.providers.anthropic_api", "AnthropicProvider"),
    "local_openai": ("prisma_loop.llm.providers.local_openai", "LocalOpenAIProvider"),
    "claude_code": ("prisma_loop.llm.providers.claude_code", "ClaudeCodeProvider"),
    "agent": ("prisma_loop.llm.providers.agent", "AgentProvider"),
    "fake": ("prisma_loop.llm.providers.fake", "FakeProvider"),
}
