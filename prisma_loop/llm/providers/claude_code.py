...
:class:`prisma_loop.llm.base.LLMProvider`. Habla con Claude Code en **modo
...
_CLEAN_ENV_FLAG = "PRISMA_LOOP_CLAUDE_CODE_CLEAN_ENV"
    ...
    def _raise_if_auth_error(output: str) -> None:
        ...
        if "401" in output or "authenticat" in low or "invalid authentication" in low:
            raise RuntimeError(
                ...
                "anthropic) en protocol.yml. Si conduces prisma-loop dentro de una "
