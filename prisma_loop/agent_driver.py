"""Conducir prisma-loop **en proceso** desde la sesión de un agente.
...
desatendidas usa ``prisma_loop.orchestration.flow.run_review`` con un proveedor
...
from prisma_loop.llm.providers.agent import AgentCallback, use_agent_callback
from prisma_loop.orchestration.pipeline import (
    FetchFn,
    PipelineResult,
    SearchFn,
    run_pipeline,
